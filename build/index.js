      ...
      this.resultsDiv.html(`
        <div class="row">
          <div class="one-third">
            ...
            ${results.generalInfo.length ? '<ul class="link-list min-list">' : "<p>No general information matches search</p>"}
              ${results.generalInfo.map(post => `<li><a href="${post.link}">${post.title}</a> ${post.postType == "post" ? `by ${post.authorName}` : ""}</li>`).join("")}
              ${results.generalInfo.length ? "</ul>" : ""}
          </div>
          <div class="one-third">
            <h2 class="search-overlay__section-title">Programs</h2>
            ${results.programs.length ? '<ul class="link-list min-list">' : `<p>No Programs matches search. <a href='${universityData.root_url}/programs'>View All Programs</a></p>`}
              ${results.programs.map(post => `<li><a href="${post.link}">${post.title}</a></li>`).join("")}
              ${results.programs.length ? "</ul>" : ""}

            <h2 class="search-overlay__section-title">Professors</h2>
            ${results.professors.length ? '<ul class="professor-cards">' : `<p>No Professors matches search.</p>`}
          ...
          <div class="one-third">
            ...
            ${results.campuses.length ? '<ul class="link-list min-list">' : "<p>No Campuses matches search. <a href='${universityData.root_url}/campuses'>View All Campuses</a></p>"}
              ${results.campuses.map(post => `<li><a href="${post.link}">${post.title}</a></li>`).join("")}
              ${results.campuses.length ? "</ul>" : ""}


            <h2 class="search-overlay__section-title">Events</h2>
            ${results.events.length ? "" : "<p>No events matches search. <a href='${universityData.root_url}/events'>View All Events</a></p>"}
